...
$MCONF['name'] = 'xMOD_tx_wfqbe_tx_wfqbe_query_querywiz';
...
class tx_wfqbe_tx_wfqbe_query_querywiz extends \TYPO3\CMS\Backend\Module\BaseScriptClass
{
    ...
    function main()
    {
        ...
        $this->doc->JScode = '
                        <script language="javascript" type="text/javascript">
                            ...
                            function updateForm() {
                                TYPO3.jQuery("#insQuery").submit(function( event ) { 
                                    ...
                                    TYPO3.jQuery.ajax({
                                            ...
                                            type: \'post\',
                                            dataType: \'html\',
                                            data: TYPO3.jQuery("#insQuery").serialize()                                            
                                    }).done(function(data) {
                                                TYPO3.jQuery("#tx_wfqbe_queryform").html(""+data);
                                            });
                                            
                                });
                                TYPO3.jQuery("#insQuery").submit();
                            }
    ...
    function moduleContent()
    {
        ...
        if (!$connection_obj) {
            ...
            $content .= '<div id="wfqbe_form">';
            $content .= $this->qbe->showForm($connection_obj['conn']);
            $content .= '</div>';
            ...
            if (\TYPO3\CMS\Core\Utility\GeneralUtility::_POST('savedok') || \TYPO3\CMS\Core\Utility\GeneralUtility::_POST('saveandclosedok')) {
                ...
                $data[$this->P['table']][$this->P['uid']][$this->P['field']] = $this->qbe->saveQuery();
                ...
                // Se è stato premuto il tasto salvataggio/uscita ,oltre a fare tutto il lavoro che si f� per il pulsante
