...
class tx_wfqbe_tx_wfqbe_query_searchwiz extends \TYPO3\CMS\Backend\Module\BaseScriptClass
{
    ...
    function main()
    {
        ...
        $this->id = $this->P['pid'];
        $this->qbe = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance("tx_wfqbe_searchform_generator");
        $this->qbe->init();
...
//        $this->doc->loadJavascriptLib('js/common.js');
        ...
        $this->doc->JScode = '
                        <script language="javascript" type="text/javascript">
                            ...
                            function updateForm() {
                                TYPO3.jQuery("#insSearch").submit(function( event ) { 
                                    ...
                                    TYPO3.jQuery.ajax({
                                            ...
                                            type: \'post\',
                                            dataType: \'html\',
                                            data: TYPO3.jQuery("#insSearch").serialize()                                            
                                    }).done(function(data) {
                                                TYPO3.jQuery("#tx_wfqbe_searchform").html(""+data);
                                            });
                                            
                                });
                                TYPO3.jQuery("#insSearch").submit();
                            }					
    ...
    function moduleContent()
    {
        ...
        if (!$connection_obj) {
            ...
            //$content.='<form action="'.htmlspecialchars($rUri).'" method="post" name="insSearch">';
            ...
            if (\TYPO3\CMS\Core\Utility\GeneralUtility::_POST('savedok') || \TYPO3\CMS\Core\Utility\GeneralUtility::_POST('saveandclosedok')) {
                ...
                if (\TYPO3\CMS\Core\Utility\GeneralUtility::_POST('saveandclosedok_x')) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wfqbe/tx_wfqbe_query_search/index.php']) {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wfqbe/tx_wfqbe_query_search/index.php']);
}
